    ...
    <div className="space-y-16 animate-in fade-in duration-500">
      <header className="max-w-2xl">
        ...
        <p className="text-lg text-slate-600 dark:text-slate-400 leading-relaxed">
          Have a question about RAN optimization? Want to collaborate on an AI project or have me speak at your event? Let's connect.
        </p>
      </header>
        ...
        <section className="space-y-12">
          ...
          <div className="p-8 rounded-3xl bg-slate-900 text-white relative overflow-hidden">
             <div className="relative z-10">
               <h3 className="text-lg font-bold mb-2">Direct Email</h3>
               <p className="text-slate-400 text-sm mb-4">For urgent inquiries, reach out directly:</p>
               <a href="mailto:fitsummergia@gmail.com" className="text-brand-cyan font-mono hover:underline">
                 fitsummergia@gmail.com
               </a>
             </div>
